...
$listehotels=$voiture->afficherVoitures();
				...
				<div class="row">
					<div class="col d-flex flex-row">
						...
						<div class="user_box ml-auto">
							<div class="user_box_login user_box_link"><a href="login.php"><?php echo $login ?></a></div>
							...
							<div class="search_panel active">
                              ...
                              <option  value="all">All</option>
                             	 <option  value="AUDI">AUDI</option>
									...
									<div class="search_item">
										<div>nb places</div>
                                        <input type="number"  min="2" max="4" step="2" title="2 ou 4"class="form-control">
									</div>
									<div class="search_item">
										<div>type</div>
...
if(($vi!="all") and ($nb=='tout les prix') )

                        {

                            $listehotels=$voiture->rechercherListeVoitures($vi);
          ...
          if(($vi!="all") and ($nb!='tout les prix'))
                        ...
                        {$listehotels=$voiture->rechercherselonmarqueprix($vi,$nb); }


                     if(($vi=="all") and ($nb!='tout les prix'))

                        {$listehotels=$voiture->rechercherselonprix($nb); }
 ...
 $nomv=$nom.'/ '.$ville;
    ...
    ?>                    
						<div class="<?php echo $offers ?>">
							<div class="row">
								<div class="col-lg-1 temp_col"></div>
								<div class="col-lg-3 col-1680-4" style="background-image:url(images/voiture.png); ">
								...
								<div class="col-lg-8">
									<div class="offers_content">
										...
										<div class="button book_button"><a href="formulairetem.php?matricules=<?PHP echo $ville; ?>">LOUER<span></span><span></span><span></span></a></div>
