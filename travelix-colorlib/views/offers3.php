...
$listevoiture=$voiture->afficherVoitures();


foreach($listevoiture as $row){

    $nbetoiles='5';
    $offers='offers_item rating_'.'5';
    $image='background-image:url(images/'.'offer_2'.'.jpg)';
    $url='https://www.automobile.tn/fr';
    $prix='$'.$row['pays'];
    $raiting='rating_r rating_r_'.'5'.' offers_rating';
    $types=$row['types'];
    $dates=$row['dates'];
                            ...
                            <div class="col fill_height no-padding">
                                ...
                                <div class="search_tabs_container">
                                    <div class="search_tabs d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
                                        <div class="search_tab active d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="images/bus.png" alt=""><span>voiture</span></div>
                                        <div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="images/manager.png" alt="">transfert</div>
                                        <div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="images/departure.png" alt="">flights</div>
                                        <div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="images/island.png" alt="">hotels</div>
                                ...
                                <div class="search_panel active">
                                    <form action="#"  id="search_form_1" name="f" onsubmit="return test2()" class="search_panel_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
                                        <div class="search_item">
                                            <div>marque</div>
                                            <select name="marque" id="marque" class="dropdown_item_select search_input" required>
                                                ...
                                                <option  value="RENAUT">RENAULT</option>
                                        ...
                                        <div class="search_item">
                                            <div>jour de debut</div>
                                            <input id="durre_location" name="date1" class="check_in search_input" type="date" oninput="test()" >
                                        </div>
                                        <div class="search_item">
                                            <div>jours de fin</div>
                                            <input id="dure_location" name="date2" class="check_out search_input" type="date" oninput="test()">
                                        </div>

                                        <div class="search_item">
                                            <div>nb places</div>
                                            <input type="number"  min="2" max="4" step="2" title="2 ou 4"class="form-control" required>
                                        </div>
                                        <div class="search_item">
                                            <div>type</div>
                                            <select name="type" id="type" class="dropdown_item_select search_input">
                                        ...
                                        <div class="search_item">
                                            <div>PRIX</div>
                                            <select class="dropdown_item_select search_input" id="prix_v" name="prix">
                                                <option value="all">tout les prix</option>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="offers_grid">
                            ...
                            <?php
                            $listevoiture=$voiture->afficherVoitures();
                            $durre_location = new DateTime();
                            $date1 = $durre_location->format('Y-m-d');
                            $demain=$date1.' +1'.' day';
                            ...
                            if ( isset($_GET['marque']) and isset($_GET['nbetoiles']) and isset($_GET['durre_location']) and isset($_GET['dure_location'])   )

                            { $date1=$_GET['dure_location'];
                                $date2=$_GET['dure_location'];
                                $ma=$_GET['marque'];
                                $nb=$_GET['nbetoiles'];
                                ...
                                if(($ma!="all") and ($nb=='toutes categories') )

                                {$listevoiture=$voiture->rechercherListeVoitures($ma); }



                                if(($ma!="all") and ($nb!='toutes categories'))

                                {$listevoiture=$voiture->rechercherselonvillecategorie($ma,$nb); }


                                if(($ma=="all") and ($nb!='toutes categories'))

                                {$listevoiture=$voiture->rechercherseloncategorie($nb); }
                            ...
                            foreach($listevoiture  as $row){
                              ...
                              // $nomv=$nom.'/ '.$ville;
                                ...
                                <div class="<?php echo $offers ?>">
                                    <div class="row">
                                        <div class="col-lg-1 temp_col"></div>
                                        <div class="col-lg-3 col-1680-4" style="background-image:url(images/offer_4.jpg); ">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="offers_content">
                                                <div class="offers_price"><?php echo $prix ?><span>par jour</span></div>
                                               <!--  <div class="<?php echo $raiting ?>" data-rating="<?php echo $nbetoiles ?>">
                                                ...
                                                <p class="offers_text"><?php echo $types ?></p>
                                                <div class="offers_icons">
                                                    <ul class="offers_icons_list">
                                                        <li class="offers_icons_item"><span style="text-transform: uppercase;font-weight: 900; color: #eda84a;"><?php echo $matricules ?></span></li>
										...
										&date1=<?php echo $date1 ?>&date2=<?php echo $date2 ?>&nbnuit=<?php echo $nbjours ?>">LOUER<span></span><span></span><span></span></a></div>
                                                <div class="offer_reviews">
                                                    <div class="offer_reviews_content">
                                                        <div class="offer_reviews_title"><?php echo $dates ?></div>
                                                        <div class="offer_reviews_subtitle"></div>
                                                    </div>
                                                    <div class="offer_reviews_rating text-center"><?php echo $nb_places ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
